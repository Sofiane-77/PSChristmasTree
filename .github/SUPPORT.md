...
The [FAQ](https://sofiane-77.github.io/PSChristmasTree/FAQ/) covers the most common questions about PSChristmasTree.

## GitHub Discussions

For anything that is not a confirmed bug, use [GitHub Discussions](https://github.com/Sofiane-77/PSChristmasTree/discussions):
...
If you have found a confirmed bug, please [open an issue](https://github.com/Sofiane-77/PSChristmasTree/issues/new/choose) using the bug report template.

## Security

If you believe you have found a security vulnerability, do not open a public issue. Follow the private disclosure process described in [SECURITY.md](SECURITY.md).

## Asking Good Questions

Spending a little extra time framing your question leads to faster, better answers. Here are some tips:
